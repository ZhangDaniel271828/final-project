...
INSERT INTO Users (username, password, realName, birthDate, blurb, isManager, imageLink) VALUES
    ('SuperGaoye', 'gaoye12345', 'gaoye', '2025-05-22', 'Hey there! I am gaoye, and I am a foodie! Also, I am a manager of this website', 1, NULL),
    ('ketchumall', '12345', 'Ash Ketchum', '1990-05-22', 'Hey there! I am Ash Ketchum from Pallet Town, dreaming of becoming a Pokémon Master.', 0, NULL),
    ('pokemondoctor', '67890', 'Joy Nurtureheart', '1985-03-15', 'I am Nurse Joy, devoted to nurturing and healing Pokémon at the Pokémon Center.', 0, NULL),
    ('growlitheisbae', 'pa55word', 'Jenny Ironwill', '1992-07-11', 'I am Officer Jenny, upholding peace and protecting Pokémon with my Growlithe.', 0, NULL),
    ('1514eva', 'pokeman', 'Samuel Oak', '1950-09-14', 'I am Professor Oak, passionate about Pokémon research and helping young trainers.', 0, NULL),
    ('mistyfan', 'watergym', 'Misty Waterflower', '1994-06-01', 'I am Misty, the Cerulean City Gym Leader, specializing in Water-type Pokémon.', 0, NULL);
